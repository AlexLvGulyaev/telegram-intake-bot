...
ScenarioType = Literal["support", "sales_lead"]
Priority = Literal["срочно", "средне", "низкий приоритет"]
LeadStatus = Literal["горячий", "теплый", "холодный"]
...
class SupportSession(BaseModel):
    ...
    # Guard-layer flags: track whether the assistant has explicitly asked
    # for optional but requested fields to avoid repeating the question.
    name_asked: bool = False
    company_asked: bool = False
